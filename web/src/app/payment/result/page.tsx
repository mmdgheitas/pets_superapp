      ...
      <CardContent className="space-y-4 p-8">
        {success ? (
          <>
            ...
            <div>
              <h1 className="font-display text-xl font-extrabold">پرداخت با موفقیت انجام شد 🎉</h1>
              <p className="mt-1 text-sm leading-7 text-muted-foreground">
                سفارش شما ثبت شد، کمیسیون فروشنده محاسبه شد و فروشنده مطلع گردید.
              </p>
            </div>

            <ul className="space-y-2 rounded-xl border bg-muted/40 p-3 text-start text-sm">
              {order && (
                <li className="flex items-center justify-between gap-2">
                  <span className="flex items-center gap-1.5 text-muted-foreground">
                    <Receipt className="h-3.5 w-3.5" /> شماره سفارش
                  </span>
                  <span dir="ltr" className="font-bold num-tabular">
                    #{order.slice(0, 10)}
                  </span>
                </li>
              )}
              {ref && (
                <li className="flex items-center justify-between gap-2">
                  <span className="flex items-center gap-1.5 text-muted-foreground">
                    <Copy className="h-3.5 w-3.5" /> کد رهگیری زرین‌پال
                  </span>
                  <span dir="ltr" className="font-medium num-tabular text-foreground">
                    {toPersianDigits(ref)}
                  </span>
                </li>
              )}
              <li className="flex items-center justify-between gap-2 border-t pt-2">
                <span className="flex items-center gap-1.5 text-muted-foreground">
                  <Store className="h-3.5 w-3.5" /> وضعیت فروشنده
                </span>
                <span className="text-xs font-bold text-success">اعلان ارسال شد</span>
              </li>
            </ul>
